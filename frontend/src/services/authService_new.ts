...
class AuthService {
  ...
  async login(username: string, password: string): Promise<LoginResponse> {
    try {
      ...
      // Log login attempt
      this.logEvent('login_attempt', { username });
  ...
  async register(userData: RegistrationData): Promise<User> {
    try {
      ...
      this.logEvent('registration_failure', {
        username: userData.username,
        error: error.message
      });
      throw error;
  ...
  async updateProfile(userData: Partial<User>): Promise<User> {
    try {
      ...
      this.logEvent('profile_update_failure', {
        error: error.message
      });
      throw error;
    }
  ...
  async changePassword(currentPassword: string, newPassword: string): Promise<void> {
    try {
      ...
      // Log password change
      this.logEvent('password_changed', {});
    } catch (error: any) {
      this.logEvent('password_change_failure', {
        error: error.message
      });
      throw error;
    }
  ...
  async requestPasswordReset(email: string): Promise<void> {
    try {
      ...
      this.logEvent('password_reset_request_failure', {
        email,
        error: error.message
      });
      throw error;
  ...
  async confirmPasswordReset(
    ...
    try {
      ...
      this.logEvent('password_reset_completed', {});
    } catch (error: any) {
      this.logEvent('password_reset_failure', {
        error: error.message
      });
      throw error;
    }
