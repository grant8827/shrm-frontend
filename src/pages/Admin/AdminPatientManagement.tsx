...
// Mock data with comprehensive patient information
const mockPatients: Patient[] = [
  {
    ...
    medical: {
      ...
      secondaryDiagnoses: ['Mild Depression', 'Sleep Disorder'],
      allergies: ['Penicillin'],
      medications: ['Sertraline 50mg', 'Melatonin 3mg'],
      primaryTherapist: 'Dr. Sarah Wilson'
    },
    appointments: {
      total: 24,
      upcoming: 2,
  ...
  },
  {
    ...
    medical: {
      ...
      allergies: [],
      medications: ['Fluoxetine 20mg', 'Adderall 10mg'],
      primaryTherapist: 'Dr. Michael Johnson'
    },
    appointments: {
      total: 18,
      upcoming: 1,
  ...
  },
  {
    ...
    medical: {
      ...
      medications: ['Prazosin 1mg', 'Naltrexone 50mg'],
      primaryTherapist: 'Dr. Emily Davis'
    },
    appointments: {
      total: 32,
      upcoming: 0,
